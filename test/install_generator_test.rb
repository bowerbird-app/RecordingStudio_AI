...
class InstallGeneratorTest < Minitest::Test
  ...
  def test_copy_initializer_creates_recording_studio_ai_configuration
    Dir.mktmpdir do |directory|
      ...
      assert_includes initializer, "Recording Studio Admin"
      refute_includes initializer, "config.admin_authenticate"
      refute_includes initializer, "config.admin_actor_resolver"
      refute_includes initializer, "config.admin_visible_roots_resolver"
      refute_includes initializer, "config.admin_layout"
  ...
  def test_install_guide_includes_v1_provider_migration_and_operations_steps
    ...
    assert_includes install_guide, "Recording Studio Admin"
    refute_includes install_guide, "admin_authenticate"
    refute_includes install_guide, "admin_visible_roots_resolver"
    refute_includes install_guide, "admin_actor_resolver"
    refute_includes install_guide, "admin_layout"

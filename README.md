...
The dedicated retained-response page requires both sensitive and retained
response permission and delegates decryption to `ResponseReader`. Ordinary run
and batch pages never read encrypted columns. All screens use only the custom
